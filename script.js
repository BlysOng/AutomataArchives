  ...
  overlay.innerHTML =
    '<div class="modal frame" role="dialog" aria-modal="true" aria-labelledby="modalTitle">' +
      ...
      '<div class="modal__shot" id="modalShotWrap">' +
        '<img class="modal__shot-img" id="modalShot" alt="">' +
...
function openWorkflowModal(wf){
  ...
  // -- screenshot: every workflow shows the same fixed-size frame
  // (see .modal__shot / .modal__shot-img in styles.css — object-fit:
  // cover means any screenshot, whatever its native size, gets
  // cropped to that same box). No wf.image yet -> show the
